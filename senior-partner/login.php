...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($username) || empty($password)) {
        ...
        $query = "SELECT id, username, password FROM senior_partners WHERE username = :username";
...
<head>
    ...
    <!-- Reuse Login Styles from Admin by embedding inline or linking. Inline for simplicity/isolation. -->
    <style>
