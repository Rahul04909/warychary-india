...
// Determine user ID and Type (Senior Partner)
// Assuming auth_check.php sets $_SESSION['senior_partner_id'] or similar?
// If senior partner auth is different, we might need to adjust.
// Based on previous tasks, there is a `senior-partner/login.php` likely setting a distinct session.
// Let's assume standard session usage, verify implementation if needed.
$user_id = $_SESSION['sp_id'] ?? $_SESSION['user_id'] ?? 0; // Fallback or check specific session key
// Check if 'sp_id' is the standard key for senior partners
if (isset($_SESSION['senior_partner_id'])) {
    $user_id = $_SESSION['senior_partner_id'];
}

$user_type = 'senior_partner';
...
<div class="page-header">
    <div class="header-title">
        <h1>Bank Details (Senior Partner)</h1>
